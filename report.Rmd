...
- Proportion of admissions going in each pathway:
    1) `r params$prop_path1`%
    2) `r params$prop_path2`%
...
kable(tab, format = "latex", booktabs = T,
      caption = "Model output from 500 model runs for three example scenarios. SD: standard deviation.",
...
* Simple ward beds are not included 
