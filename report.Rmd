...
Results from 500 model runs for each of the 3 scenarios (base, 20% reduction and 60% reduction) are presented below in Figures \@ref(fig:base), \@ref(fig:x20), \@ref(fig:x60) and \@ref(fig:deaths), and Tables \@ref(tab:Tbase), \@ref(tab:Tx20), \@ref(tab:Tx60) and \@ref(tab:Tsummary).
...
tab = table_multi(results_base, results_x20, results_x60, save = F)
knitr::kable(results_base, caption = "Model output from 500 model runs for the base reduction scenario.")
...
tab = table_multi(results_base, results_x20, results_x60, save = F)
knitr::kable(results_x20, caption = "Model output from 500 model runs for the base reduction scenario.")
...
tab = table_multi(results_base, results_x20, results_x60, save = F)
knitr::kable(results_x60, caption = "Model output from 500 model runs for the base reduction scenario.")
...
kable(tab, format = "latex", booktabs = T,
      caption = "Model output from 500 model runs.",
      col.names = c("Scenario",
                    "Peak time", "Mean beds", "SD",
                    "Peak time","Mean beds", "SD",
                    "Cumulative deaths")) %>%
  kable_styling(latex_options = c("striped", "scale_down")) %>%
  add_header_above(c(" " = 1, "ICU peak bed needs" = 3, "HDU peak bed needs" = 3, " " = 1))
