...
cov_curve_all = read.csv(paste0(base_dir, "/data/200402_pietro_preds.csv"))
...
results_x73$date <- seq(start_date, by = "days", length.out = length(results_x73[,1]))
...
tab = table_multi(results_base, results_x20, results_x40, results_x50, results_x60, results_x73,
...
plot_multi(results_x73, save = T, filename = paste0(base_dir, "/outputs/cov_pred_x73"))
...
results_base_tab$total = round(cov_curve_all$X0red*0.255)
...
results_x20_tab = results_x20 %>%
  ...
  select(date, ICU_beds, ICU_beds_sd, HDU_beds, HDU_beds_sd,
         ward_beds, ward_beds_sd, deaths, deaths_sd)
results_x20_tab$total = round(cov_curve_all$X20red*0.255)
...
results_x40_tab = results_x40 %>%
  ...
  select(date, ICU_beds, ICU_beds_sd, HDU_beds, HDU_beds_sd,
         ward_beds, ward_beds_sd, deaths, deaths_sd)
results_x40_tab$total = round(cov_curve_all$X40red*0.255)
...
results_x50_tab = results_x50 %>%
  ...
  select(date, ICU_beds, ICU_beds_sd, HDU_beds, HDU_beds_sd,
         ward_beds, ward_beds_sd, deaths, deaths_sd)
results_x50_tab$total = round(cov_curve_all$X50red*0.255)
...
results_x60_tab = results_x60 %>%
  ...
  select(date, ICU_beds, ICU_beds_sd, HDU_beds, HDU_beds_sd,
         ward_beds, ward_beds_sd, deaths, deaths_sd)
results_x60_tab$total = round(cov_curve_all$X60red*0.255)
...
results_x73_tab = results_x73 %>%
  ...
  select(date, ICU_beds, ICU_beds_sd, HDU_beds, HDU_beds_sd,
         ward_beds, ward_beds_sd, deaths, deaths_sd)
results_x73_tab$total = round(cov_curve_all$X73red*0.255)
