...
```{r deaths, fig.cap="Estimated incidence of mortality in COVID19 hospitalised patients from 500 model runs. Scenarios are: 0% reduction in contact rate (base), 20% reduction in contact rate, and 60% reduction in contact rates. Lines are average daily incidence, shaded area represents average +/- standard deviation."}
...
ggplot() +
  ...
  scale_colour_discrete(breaks = c("1", "2", "3"),
                        labels = c("Base", "20% reduction", "60% reduction")) +
